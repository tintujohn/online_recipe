      ...
      return (
       <div>
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>
              Please Add following details to publish your recipe.
            </DialogContentText>
            <TextField
              autoFocus
              margin="dense"
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(AddRecipe));