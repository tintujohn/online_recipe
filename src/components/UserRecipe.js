  ...
  render() {
    ...
    const { spacing } = this.state;
      ...
      return <Grid key={item.recipeId} item>
        ...
        <br/>
        <br/>
        {item.comment.length !== 0 ? <Typography color="textPrimary">Comments</Typography>:  null}
        {item.comment.map((element) => {
           return (<Typography color="textSecondary" key={element.commentId}>
...
export default withStyles(styles)(connect(mapStateToProps, null)(UserRecipe));